...
public class WorldGenTreesLoader implements IWorldGenerator {
    public static final WorldGenerator LEMON = new WorldGenLemonTree();
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        switch (world.provider.getDimension()) {
            case 1:
                break;
            case 0:
                runGenerator(LEMON, world, random, chunkX, chunkZ, 5, Blocks.DIRT, BiomePlains.class);
                break;
            case -1:
        }
    }
