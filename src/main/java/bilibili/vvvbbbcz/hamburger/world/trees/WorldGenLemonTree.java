package bilibili.vvvbbbcz.hamburger.world.trees;
...
public class WorldGenLemonTree extends WorldGenAbstractTree {
    public static final IBlockState LOG = RegisterLoader.blockLemonLog.getDefaultState();
    public static final IBlockState LEAF = RegisterLoader.blockLemonLeaf.getDefaultState();
